...
-- EXTENDED: We check for 30 minutes and 60 minutes target window per reference point: So positive_event has to be positive_event_15, then add positive_event_30 and positive_event_60
-- We get three seperate datasets: 
--1) merged_mix_features_extended
--2) merged_inv_features_extended
--3) merged_noninv_features_extended
...
CREATE Table ce_approach.merged_mix_features_extended AS 
SELECT 
