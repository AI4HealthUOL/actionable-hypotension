...
CREATE TABLE evaluation.sapsii AS 
-- ------------------------------------------------------------------
...
(
  ...
  from evaluation.blood_gas_first_day_arterial bg
  left join evaluation.ventilation_durations vd
...
left join evaluation.gcs_first_day gcs
  on ie.icustay_id = gcs.icustay_id
left join evaluation.vitals_first_day vital
  on ie.icustay_id = vital.icustay_id
left join evaluation.urine_output_first_day uo
  on ie.icustay_id = uo.icustay_id
left join evaluation.labs_first_day labs
