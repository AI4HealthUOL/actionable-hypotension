# I need a table that has all subject ids and then my subgroup columns:
# exclusion (0/1)
# age 
# saps
# sofa
...
DROP TABLE if exists evaluation.fused_subgroups_mv 

CREATE TABLE evaluation.fused_subgroups_mv as 
SELECT 
    ie.subject_id,
    ie.hadm_id,
    ie.icustay_id,
